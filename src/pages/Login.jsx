      ...
      <div className="w-2/3 h-screen flex flex-col items-center justify-center">
        ...
        <div className="flex flex-col gap-1">
          <div className="flex flex-col gap-5 items-center">
            <input className="bg-background border-2 border-backgroundBlue w-[400px] h-[55px] rounded-[10px] p-4 outline-none font-extralight" placeholder="Digite seu E-mail" type="email" name="" id="" required />
            <input className="bg-background border-2 border-backgroundBlue w-[400px] h-[55px] rounded-[10px] p-4 outline-none font-extralight" placeholder="Digite sua Senha" type="password" name="" id="" required />
          </div>
          <div className="flex">
